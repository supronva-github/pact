...
2. Исправить опечатку Skil. Есть 2 пути решения. Описать оба.
  - через self.table = 'skils' <= добавил в коде класс
  - Через миграции:
    1) Создаем новую таблицу
    2) Пишем в 2 таблице
    3) Делаем Backfill из старой таблицы в новую
    4) Переключаем чтение из старой таблицы в новую таблицу
    5) Перестаем писать в старую таблицу
